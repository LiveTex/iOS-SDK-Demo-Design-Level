 ...
 */
@property (strong, nonatomic) UIColor *messagesHeaderTextColor;
 ...
 *  that is configured using the collection view's messagesHeaderTextColor property.
 *
 *  @param indexPath The index path specifying the location of the supplementary view in the collection view. This value must not be `nil`.
 *
 *  @return A valid `JSQMessagesHeaderView` object.
 */
- (JSQMessagesHeaderView *)dequeueLoadEarlierMessagesViewHeaderForIndexPath:(NSIndexPath *)indexPath;

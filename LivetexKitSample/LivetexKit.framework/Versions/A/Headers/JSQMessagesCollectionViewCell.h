 ...
 */
@property (strong, nonatomic, readonly) JSQMessagesLabel *cellTopLabel;
 ...
 */
@property (strong, nonatomic, readonly) JSQMessagesLabel *messageBubbleTopLabel;

/**
 *  Returns the label that is pinned to the middle of the cell.
 *  This label is most commonly used to display message timestamps.
 */
@property (strong, nonatomic, readonly) JSQMessagesLabel *cellMiddleLabel;
 ...
 */
@property (strong, nonatomic, readonly) JSQMessagesLabel *cellBottomLabel;
 ...
 */
@property (strong, nonatomic, readonly) JSQMessagesCellTextView *textView;
 ...
 */
@property (strong, nonatomic, readonly) UIView *messageBubbleContainerView;
 ...
 *  Doing so could result in unexpected behavior.
 */
@property (strong, nonatomic, readonly) UIView *avatarContainerView;
...
- (void)setupConstraints:(BOOL)isIncomingCell;

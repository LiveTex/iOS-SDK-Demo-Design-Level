...
/**
 *  Asks the delegate for the height of the `cellMiddleLabel` for the item at the specified indexPath.
 *
 *  @param collectionView       The collection view object displaying the flow layout.
 *  @param collectionViewLayout The layout object requesting the information.
 *  @param indexPath            The index path of the item.
 *
 *  @return The height of the `cellMiddleLabel` for the item at indexPath.
 *
 *  @see JSQMessagesCollectionViewCell.
 */
- (CGFloat)collectionView:(JSQMessagesCollectionView *)collectionView
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForCellMiddleLabelAtIndexPath:(NSIndexPath *)indexPath;
...
- (void)collectionView:(JSQMessagesCollectionView *)collectionView
                header:(JSQMessagesHeaderView *)headerView didTapLoadEarlierMessagesButton:(UIButton *)sender;

...
/**
 *  Asks the data source for the text to display in the `messages header view` for the specified
 ...
 */
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForMessagesHeaderViewAtIndexPath:(NSIndexPath *)indexPath;
...
/**
 *  Asks the data source for the text to display in the `cellMiddleLabel` for the specified
 *  message data item at indexPath in the collectionView.
 *
 *  @param collectionView The collection view requesting this information.
 *  @param indexPath      The index path that specifies the location of the item.
 ...
 *  @see JSQMessagesCollectionViewCell.
 */
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForCellMiddleLabelAtIndexPath:(NSIndexPath *)indexPath;

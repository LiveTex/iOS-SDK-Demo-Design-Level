...
/**
 *  @return The default bad mark image
 */
+ (UIImage *)jsq_badMarkImage;

/**
 *  @return The default good mark image
 */
+ (UIImage *)jsq_goodMarkImage;

/**
 *  @return The estimation image
 */
+ (UIImage *)jsq_estimationImage;
